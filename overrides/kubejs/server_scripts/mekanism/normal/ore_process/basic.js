...
ServerEvents.recipes(event => {
    let either_processing = (id) => {
        ...
        event.custom(
            { type: 'mekanism:washing', fluidInput: { 'amount': 5, 'fluid': 'minecraft:water' }, slurryInput: { 'amount': 1, 'slurry': 'mekanism:dirty_' + id }, output: { 'slurry': 'mekanism:clean_' + id, 'amount': 10 } },
        )
    }
    ...
    event.custom({ "type": "mekanism:crushing", "input": { "ingredient": { "count": 1, "item": "mek1000:softore_certus_quartz" } }, "output": { "count": 8, "item": "ae2:certus_quartz_dust" } }) //2.6
    ...
    event.custom({ "type": "mekanism:crushing", "input": { "ingredient": { "count": 1, "item": "mek1000:softore_fluorite" } }, "output": { "count": 6, "item": "mekanism:dust_fluorite" } }) //2.6
    ...
    event.custom( //5-1
        { type: 'mekanism:washing', fluidInput: { 'amount': 5, 'fluid': 'minecraft:water' }, slurryInput: { 'amount': 1, 'slurry': 'mek1000:dirty_fluorite' }, output: { "slurry": "mek1000:clean_fluorite", 'amount': 10 } },
    )
    event.custom({
        "type": "mekanism:crystallizing",
        "chemicalType": "slurry",
    ...
    event.custom({ "type": "mekanism:crushing", "input": { "ingredient": { "count": 1, "item": "mek1000:softore_quartz" } }, "output": { "count": 6, "item": "mekanism:dust_quartz" } }) //2.6
    ...
    event.custom( //5-1
        { type: 'mekanism:washing', fluidInput: { 'amount': 5, 'fluid': 'minecraft:water' }, slurryInput: { 'amount': 1, 'slurry': 'mek1000:dirty_quartz' }, output: { "slurry": "mek1000:clean_quartz", 'amount': 10 } },
    )
    event.custom({
        "type": "mekanism:crystallizing",
        "chemicalType": "slurry",
    ...
    event.recipes.mekanism.enriching(`8x kubejs:dust_iridium`, 'kubejs:ore_iridium')
    event.recipes.mekanism.purifying(`32x kubejs:clump_iridium`, 'kubejs:ore_iridium', '1x mekanism:oxygen')
    event.recipes.mekanism.injecting(`64x kubejs:shard_iridium`, 'kubejs:ore_iridium', '1x mekanism:hydrogen_chloride')
    event.custom({
        type: "mekanism:dissolution", itemInput: { "ingredient": { "item": 'kubejs:ore_iridium' } }, gasInput: { "amount": 1, "gas": "mekanism:sulfuric_acid" }, output: { "slurry": "kubejs:dirty_iridium", "amount": Math.min(10000, 10000), "chemicalType": "slurry" }
    })
    event.custom(
    ...
    event.custom( //5-1
        { type: 'mekanism:washing', fluidInput: { 'amount': 5, 'fluid': 'minecraft:water' }, slurryInput: { 'amount': 1, 'slurry': 'mek1000:dirty_redstone' }, output: { "slurry": "mek1000:clean_redstone", 'amount': 10 } },
    )
    event.custom({
        "type": "mekanism:crystallizing",
        "chemicalType": "slurry",
