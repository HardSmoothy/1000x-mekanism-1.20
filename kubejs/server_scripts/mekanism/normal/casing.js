ServerEvents.recipes(event => {
    ...
    event.shaped('mek1000:gas_input', [
        'gge',
        'gte',
        'gee'
    ], {
    ...
    event.shapeless('mek1000:imitation_sps_port', ['mekanism:sps_port', 'mekanism_extras:alloy_radiance'])

    event.shaped('mek1000:item_input', [
        'e  ',
        't  ',
        '   '
    ], {
    ...
    event.shaped('mek1000:item_output', [
        '   ',
        't  ',
        'e  '
    ], {
    ...
    event.shaped('mek1000:singurarity_gas_input', [
        'eee',
        'ete',
        'eee'
    ], {
