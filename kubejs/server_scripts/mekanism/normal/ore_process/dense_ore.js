...
ServerEvents.recipes(event => {
    ...
    let appendix_extreme = (input_item, ore_type, multiplier) => {
        if (ore_type == "redstone") {
            ...
            event.recipes.mekanism.enriching(`${Math.floor(multiplier * 2)}x minecraft:${ore_type}`, input_item)
            ...
            event.custom({
                ...
                "itemOutput": { "item": `mek1000:purified_${ore_type}_rawore`, "count": multiplier * 6 }
            })
            ...
            event.custom({
                ...
                "gasInput": { "amount": multiplier * 600, "gas": "mek1000:active_aqua_regia" },
                "energyRequired": 1, "duration": multiplier * 6,
                "itemOutput": { "item": `mek1000:purified_lapis_rawore`, "count": multiplier * 6 }
            })
    ...
    appendix_extreme("denseores:dense_coal_ore", "coal", 3)
    appendix_extreme("denseores:dense_deepslate_coal_ore", "coal", 3)
    appendix_extreme("denseores:dense_copper_ore", "copper", 3)
    appendix_extreme("denseores:dense_deepslate_copper_ore", "copper", 3)
    appendix_extreme("denseores:dense_diamond_ore", "diamond", 3)
    appendix_extreme("denseores:dense_deepslate_diamond_ore", "diamond", 3)
    appendix_extreme("denseores:dense_emerald_ore", "emerald", 3)
    appendix_extreme("denseores:dense_deepslate_emerald_ore", "emerald", 3)
    appendix_extreme("denseores:dense_gold_ore", "gold", 3)
    appendix_extreme("denseores:dense_deepslate_gold_ore", "gold", 3)
    appendix_extreme("denseores:dense_nether_gold_ore", "gold", 3)
    appendix_extreme("denseores:dense_iron_ore", "iron", 3)
    appendix_extreme("denseores:dense_deepslate_iron_ore", "iron", 3)
    appendix_extreme("denseores:dense_lapis_ore", "lapis_lazuli", 3)
    appendix_extreme("denseores:dense_deepslate_lapis_ore", "lapis_lazuli", 3)
    ...
    appendix_extreme("densemekanism:dense_osmium_ore", "osmium", 3)
    appendix_extreme("densemekanism:dense_deepslate_osmium_ore", "osmium", 3)

    appendix_extreme("densemekanism:dense_tin_ore", "tin", 3)
    appendix_extreme("densemekanism:dense_deepslate_tin_ore", "tin", 3)
    appendix_extreme("densemekanism:dense_uranium_ore", "uranium", 3)
    appendix_extreme("densemekanism:dense_deepslate_uranium_ore", "uranium", 3)
    appendix_extreme("densemekanism:dense_fluorite_ore", "fluorite", 3)
    appendix_extreme("densemekanism:dense_deepslate_fluorite_ore", "fluorite", 3)
    appendix_extreme("kubejs:dense_ore_iridium", "iridium", 3)
})