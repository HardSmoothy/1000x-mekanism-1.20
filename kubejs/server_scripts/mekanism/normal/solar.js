ServerEvents.recipes(event => {
    ...
    let removeSolar2 = ['mekanismadvancedgenerators:big_advanced_solar_generator', 'mekanismadvancedgenerators:big_hybrid_solar_generator', 'mekanismadvancedgenerators:big_ultimate_solar_generator', 'mekanismadvancedgenerators:big_quantum_solar_generator', 'mekanismadvancedgenerators:big_singular_solar_generator', 'mekanismadvancedgenerators:big_light_absorbing_solar_generator', 'mekanismadvancedgenerators:big_photonic_solar_generator', 'mekanismadvancedgenerators:big_creative_solar_generator']
